...
const palette=(seed:string):[string,string,string]=>seed.includes('rosso')?['#7f1d1d','#ffffff','#f59e0b']:seed.includes('blu')?['#1e3a8a','#ffffff','#22d3ee']:seed.includes('verde')?['#14532d','#ffffff','#facc15']:seed.includes('casa')?['#334155','#ffffff','#38bdf8']:seed.includes('home')?['#3f3f46','#ffffff','#a3e635']:['#4c1d95','#ffffff','#fb7185'];
