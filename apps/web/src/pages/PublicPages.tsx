...
export function LandingPage() {
  return <div className="public-page">
    <header className="public-nav"><Link className="public-logo" to="/">SocialPilot AI</Link><nav><Link to="/pricing">Piani</Link><Link to="/app">Demo prodotto</Link><Link to="/login">Accedi</Link><Link className="button small" to="/register">Crea account</Link></nav></header>
    <main>
