...
export const QA_ACTION_PROVIDER = "BRAND_ANALYZE_QA_PROVIDER_CALL";
export const QA_ACTION_BARRIER = "BRAND_ANALYZE_QA_BARRIER_RELEASE";
export const QA_ACTION_BACKGROUND = "BRAND_ANALYZE_QA_BACKGROUND_DONE";
export const QA_EMAIL = /^brand-qa-([0-9]{8,24})-[ab]@example\.invalid$/;
export const PREVIEW_HOST = /^brandqa-[0-9]+-autoposter\.02alessandrocaruso\.workers\.dev$/;
let cachedSql = null;
