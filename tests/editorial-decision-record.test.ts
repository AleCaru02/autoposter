...
const timed = buildEditorialDecisionRecord({ topic: "Consiglio locale", provider: "INSTAGRAM", format: "STORY", eligible: true, approvalStatus: "PENDING", masterDecision: { rationale: "Decisione verificata", timing: { source: "LEARNING", scheduledAt: "2026-09-21T16:00:00.000Z" } } });
assert.match(timed.entries.find((entry) => entry.label === "Orario")!.detail, /apprendimento da risultati reali/);
