...
export const QA_ACTION_PROVIDER = "IMAGE_GENERATE_QA_PROVIDER_CALL";
export const QA_ACTION_BARRIER = "IMAGE_GENERATE_QA_BARRIER_RELEASE";
export const QA_ACTION_BACKGROUND = "IMAGE_GENERATE_QA_BACKGROUND_DONE";
export const QA_EMAIL = /^image-qa-([0-9]{8,24})-[ab]@example\.invalid$/;
export const PREVIEW_HOST = /^imageqa-[0-9]+-autoposter\.02alessandrocaruso\.workers\.dev$/;
let cachedSql = null;
