...
async function fixture(sql,marker,profileId){
  ...
  const strategy={autopilotEnabled:true,approvalMode:"MANUAL_REVIEW",researchMode:"BRAND_ONLY",monthlyAiBudgetUsd:5,monthlyImageLimit:0,maxGenerationsPerDay:1,maxGenerationsPerWeek:1,generateImagesAfterApproval:true,aiStrategyGeneratedAt:generatedAt,aiEditorialPlanGeneratedAt:generatedAt,aiEditorialPlan:plan};
