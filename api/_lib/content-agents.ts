...
export const CONTENT_AGENTS: readonly AgentDefinition[] = [
  ...
  { role: "FACT_CHECKER", responsibility: "Controlla tramite API OpenAI date, numeri, norme e affermazioni esterne; non trasforma fatti generali in claim del brand.", mayUseOpenAI: true, mayUseWeb: true, blocksOnFailure: true },
