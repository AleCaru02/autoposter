...
export const CAPABILITY_REGISTRY = define({
  ...
  "analytics.instagram.normalize": { classification: "INTERNAL", limitType: "NOT_APPLICABLE", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  "analytics.facebook.normalize": { classification: "INTERNAL", limitType: "NOT_APPLICABLE", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  "analytics.linkedin.normalize": { classification: "INTERNAL", limitType: "NOT_APPLICABLE", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  "analytics.gbp.normalize": { classification: "NOT_READY", limitType: "NOT_APPLICABLE", status: "PARTIAL" },
  "analytics.sync": { classification: "INTERNAL", limitType: "NOT_APPLICABLE", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  "analytics.read": { classification: "CORE_ALL_PLANS", limitType: "UNLIMITED", status: "LIVE_NOT_RUNTIME_VERIFIED" },
