...
export const CAPABILITY_REGISTRY = define({
  ...
  "brand.analyze": { classification: "USAGE_LIMITED", limitType: "COUNT_PER_MONTH", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  "brand.manage": { classification: "CORE_ALL_PLANS", limitType: "UNLIMITED", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  "ai.content.generate_text": { classification: "USAGE_LIMITED", limitType: "COUNT_PER_MONTH", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  ...
  "ai.strategy.generate": { classification: "USAGE_LIMITED", limitType: "COUNT_PER_MONTH", status: "LIVE_NOT_RUNTIME_VERIFIED" },
  ...
  "ai.image.generate": { classification: "USAGE_LIMITED", limitType: "COUNT_PER_MONTH", status: "LIVE_NOT_RUNTIME_VERIFIED" },
